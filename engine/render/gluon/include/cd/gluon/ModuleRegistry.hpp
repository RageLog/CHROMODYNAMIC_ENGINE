// =============================================================================
// CHROMODYNAMIC — cd/gluon/ModuleRegistry.hpp
...
//
// The authoritative sources are engine/render/gluon/shaders/modules/
...
// self-contained: consumers link cd::gluon and never touch the
...
struct ModuleDesc
{
    std::string_view virtual_path;  ///< e.g. "cd/gluon/brdf.glsl"
...
/// Lookup by canonical virtual path ("cd/gluon/brdf.glsl") or the
