...
using cd::post_motion_blur::reduce_tile_max;
using cd::post_motion_blur::Settings;
...
{
    EXPECT_FALSE(cd::post_motion_blur::kVelocityTileMaxCS.empty());
    EXPECT_FALSE(cd::post_motion_blur::kMotionBlurGatherCS.empty());
}
