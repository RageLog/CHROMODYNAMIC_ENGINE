...
using cd::post_taa::clip_aabb;
using cd::post_taa::halton;
using cd::post_taa::jitter_offset;
using cd::post_taa::neighborhood_box;
using cd::post_taa::resolve;
using cd::post_taa::Settings;
...
{
    EXPECT_FALSE(cd::post_taa::kTaaResolveCS.empty());
    EXPECT_NE(cd::post_taa::kTaaResolveCS.find("clip_aabb"),
