...
using cd::volumetric_clouds::density;
using cd::volumetric_clouds::height_fraction;
using cd::volumetric_clouds::remap;
using cd::volumetric_clouds::Settings;
...
{
    EXPECT_FALSE(cd::volumetric_clouds::kCloudsMarchCS.empty());
}
