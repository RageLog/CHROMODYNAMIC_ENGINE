...
TEST(Bc7, Compress4x4Block)
{
    ...
    auto r = cd::asset_image::compress_bc7(rgba, 4, 4);
...
TEST(Bc7, Compress16x16YieldsSixteenBlocks)
{
    ...
    auto r = cd::asset_image::compress_bc7(rgba, 16, 16);
...
TEST(Bc7, NonMultipleOf4DimensionsRoundUp)
{
    ...
    auto r = cd::asset_image::compress_bc7(rgba, 5, 3);
    ASSERT_TRUE(r.has_value());
...
TEST(Bc7, FastVsHighQualityProducesDifferentOutput)
{
    ...
    auto fast = cd::asset_image::compress_bc7(rgba, 16, 16, cd::asset_image::Bc7Quality::kFast);
    auto high = cd::asset_image::compress_bc7(rgba, 16, 16, cd::asset_image::Bc7Quality::kHigh);
