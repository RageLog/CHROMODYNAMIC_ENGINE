// =============================================================================
// CHROMODYNAMIC — cd/asset_ktx2/AssetLoader.hpp
//
...
{
public:
    explicit Ktx2Asset(Ktx2 k) noexcept : ktx_ { std::move(k) } {}
    [[nodiscard]] std::string_view tag() const noexcept override { return "ktx2"; }
    [[nodiscard]] const Ktx2& ktx2() const noexcept { return ktx_; }
private:
    Ktx2 ktx_;
};
