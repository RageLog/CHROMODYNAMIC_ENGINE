...
// phase844-W8-BE-rt-bindless-texture-sampling (auto-synced from .glsl):
// extended to also return the hit primitive (triangle) index AND
// barycentrics so the caller can recover the per-vertex UV at the
// hit point by indexing the Sponza VB/IB SSBOs.
