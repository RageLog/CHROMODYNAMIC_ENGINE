...
int main()
{
    ...
    while (true)
    {
        ...
        const cd::math::Mat4f view = cd::math::look_at(
            cd::math::Vec3f { 2.5F, 1.6F, 2.5F },
        ...
        const cd::math::Mat4f proj = cd::math::perspective(
            /*fov_y_rad=*/1.0F,
            aspect,
            /*near=*/0.1F,
            /*far=*/100.0F
        );
        const cd::math::Mat4f mvp = proj * view * model;
