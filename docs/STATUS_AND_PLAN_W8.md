...
| E      | Clang-tidy rule promotion           | 928, 936, 940, 941, 943, 944, 945, 947, 950, 951, 952, 955, 957, 965, 971 | **162 additional rules** swept through bugprone + cert + cppcoreguidelines + hicpp + modernize + performance + portability + readability + concurrency + misc families. **9 → 171** in WarningsAsErrors (**19.0x**). Each promotion preceded by a probe pass; rules with warnings get site-by-site fixes (~36 fix sites across phases 941/943/944/945/946/950/952/971) before promotion. Security-review flagged iterator-invalidation in phase 945's range-for conversion; fixed via snapshot pattern in phase 946. Run 26 queue (~52 modernize-use-ranges + use-auto + performance-* sites) deferred for future site-by-site sweep. |
